...
from raw_intensity import group_standard_intensities, raw_standard_intensity_plots, raw_standard_intensity_ratio_plots, raw_standard_intensity_ratio_fit_plots
...
def main():
  ...
  if uploaded_file is not None and uploaded_file != 0:
    ...
    # intensity_stats_figs = raw_standard_intensity_stats_plots(
    #    df_intensity_group)
